...
res_net = keras.applications.MobileNetV2(include_top=False, weights='imagenet', input_tensor=x_tensor)
...
transfer_learning_model.fit(train_dataset, validation_data=val_dataset, epochs=30, callbacks=[model_checkpoint_callback])
transfer_learning_model = keras.models.load_model("best_model.keras")
print(10*"*", '\nRun Evaluation: ')
